package com.boot.sample.repository;

import com.boot.sample.SprinBootDemoApp;
import com.boot.sample.config.Constants;
import com.boot.sample.config.audit.AuditEventConverter;
import com.boot.sample.domain.PersistentAuditEvent;
...
import static com.boot.sample.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
